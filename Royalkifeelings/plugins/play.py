    ...
    if replied:
        if replied.audio or replied.voice:
            ...
            if chat_id in QUEUE:
                ...
                await m.reply_photo(
                    photo=playimg,
                    caption=f"**✰ нєαяτ ϐєєτ мυѕιϲ ❤️ Ʌɗɗəɗ Søŋʛ 💫\n**ƦɛqʉʂƮɜɖ Ɓɤ :{m.from_user.mention()}",
             ...
             try:
                ...
                await m.reply_photo(
                    photo=playimg,
                    caption=f"**✰ нєατϐєєτ мυѕιϲ мυѕιϲ 😄 ℘ɭʌɤɪɴʛ 📀 \nƦɛqʉʂƮɜɖ Ɓɤ :{requester}**",
                    reply_markup=InlineKeyboardMarkup(buttons),
                )
             except Exception as e:
                await pokemon.delete()
        ...
        if len(m.command) < 2:
         await m.reply_photo(
                    ...
                    caption=f"**ᑌʂ𝚊𝚐𝚎: /play [ʍᴜᴤɪᴄ ɴᴀᴍᴇ ᴏʀ ʏᴏᴜᴛᴜʙᴇ ʟɪɴᴋ ᴏʀ ʀᴇᴘʟᴀʏ ᴛᴏ ᴀᴜᴅɪᴏ]ɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴘʟᴀʏ ωнιτє ∂єνιℓ ʙᴏᴛ'ᴤ ᴤᴇʀᴠᴇᴇ ᴘʟᴀʏʟɪᴤᴛ.**"),
            ...
            if search == 0:
                ...
                if Royalboyamit == 0:
                    ...
                    if chat_id in QUEUE:
                        ...
                        await m.reply_photo(
                            photo=playimg,
                            caption=f"**✰ нєαяτ ϐєєτ мυѕιϲ Ρɭʌϔɪɲʛ ₦ø̛ɯ ❤️ Ʌɗɗəɗ Søŋʛ ϐγ 💫🤟** :{requester}",
                        ...
                        try:
                            ...
                            await m.reply_photo(
                                photo=playimg,
                                caption=f"**✰ нєαяτ ϐєєτ Ɱϋƨɪƈ Ρɭʌϔɪɲʛ ₦ø̛ɯ 😄 ℘ɭʌɤɪɴʛ 📀 Ʌʈ 🤟 \nƦɛqʉʂƮɜɖ Ɓɤ :{requester}**",
                                reply_markup=InlineKeyboardMarkup(keyboard),
                            )
